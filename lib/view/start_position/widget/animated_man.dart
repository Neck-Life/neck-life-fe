...
class AnimatedMan extends StatefulWidget {
  const AnimatedMan({super.key});

  @override
  State<StatefulWidget> createState() => _AnimatedManState();
}

class _AnimatedManState extends State<AnimatedMan> with SingleTickerProviderStateMixin {
                ...
                children: [
                  Positioned(
                    ...
                    child: Transform.rotate(
                      angle: _rotateAnimation.value, // **calculate based on head pos
                  ...
                  Positioned(
                    top: res.percentWidth(30)*0.15+sin(_rotateAnimation.value).abs()*res.percentWidth(30)*0.15,
                    left: res.percentWidth(30)*0.5-res.percentWidth(30)*0.03+_cosWithWeight(_rotateAnimation.value, res.percentWidth(5)),
                    child: Transform.rotate(
                  ...
                  Positioned(
                      top: res.percentHeight(9),
                      left: res.percentWidth(60)*0.5-res.percentWidth(30)*0.03+_cosWithWeight(_rotateAnimation.value, res.percentWidth(5)),
